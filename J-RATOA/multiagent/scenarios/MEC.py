    ...
    def make_world(self):
        ...
        for i, agent in enumerate(world.agents):
            if i < len(world.agents)/2:
                ...
                agent.x_pos = randompoint.random_points_in_circle(num_agents, world.radius)[i][0]
                # agent.x_pos = uniformpoint.evenly_distributed_points_in_circle(num_agents, world.radius)[i][0]
                agent.y_pos = randompoint.random_points_in_circle(num_agents, world.radius)[i][1]
                # agent.y_pos = uniformpoint.evenly_distributed_points_in_circle(num_agents, world.radius)[i][1]
